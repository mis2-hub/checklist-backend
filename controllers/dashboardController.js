...
export const getDashboardData = async (req, res) => {
  try {
    ...
    const remarkCol = isChecklist ? "remark" : "remarks";
    const adminDoneCol = isChecklist ? "admin_done" : "NULL as admin_done";
    const adminDoneRemarksCol = isChecklist ? "admin_done_remarks" : "adminremarks as admin_done_remarks";
